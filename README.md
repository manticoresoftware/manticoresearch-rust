...
❗ WARNING: this is a development version of the client. The latest release's readme is https://github.com/manticoresoftware/manticoresearch-rust/tree/2.2.0
...
| 2.2.0 or newer              | 28.6.6 or newer                     | 1.80 or newer  | ✅ Fully Compatible       |
| 2.2.0 or newer              | 17.5.1 to 28.6.6                    | 1.80 or newer  | ⚠️ Partially Compatible  |
| 2.0.0 to 2.2.0              | 28.6.6 or newer                     | 1.80 or newer  | ⚠️ Partially Compatible  |
| 2.0.0 to 2.2.0              | 17.5.1 to 28.6.6                    | 1.80 or newer  | ✅ Fully Compatible       |
| 1.0.0 to 2.0.0              | 17.5.1 to 28.6.6                    | 1.80 or newer  | ⚠️ Partially Compatible  |

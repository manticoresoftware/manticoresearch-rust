...
❗ WARNING: this is a development version of the client. The latest release's readme is https://github.com/manticoresoftware/manticoresearch-rust/tree/2.1.0
...
| 2.1.0 or newer              | 28.4.4 or newer                     | 1.80 or newer  | ✅ Fully Compatible     |
| 2.0.0 to 2.1.0              | 28.4.4 or newer                     | 1.80 or newer  | ⚠️ Partially Compatible |
| 2.0.0 to 2.1.0              | 17.5.1 to 28.4.4                    | 1.80 or newer  | ✅ Fully Compatible     |
